      ...
      <div className="info-modal">
        ...
        <div className="info-text">
          ...
          <div className='info-section'>
            <h5>Sign up or Log In for the ability to create alerts for others.</h5>
            <p>Anonymous users will still have access to all other functionalities.</p>
          </div>
          <div className='info-section'>
            <h5>Use the toggle button on the top left of the map to switch the transit layer on and off.</h5>
          </div>
          <div className='info-section'>
            <h5>As alerts are created, color coded markers will pop up at each station where the alert is located.</h5>
            <p>Each marker on the map can be clicked to pop up a display of the alert details.</p>
          </div>
          <div className='info-section'>
          ...
          <div className='info-section'>
            <h5>All alerts will be displayed on the bottom right in chronological order.</h5>
          </div>
          <div className='info-section'>
